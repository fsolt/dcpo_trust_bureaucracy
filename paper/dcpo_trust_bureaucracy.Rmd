...
However, as long as public administration research fails to be comparative, claims for a "science of public administration" remain unconvincing [@Dahl1947, pp. 8].
While comparative studies offer valuable insights and innovative concepts, they face significant methodological challenges [@Pollitt2011], with measurement equivalence being one of the most critical.
...
Our findings reveal that while government outcomes (e.g., economic performance and public security) have short-term effects, government quality (e.g., effectiveness) exerts more significant, long-lasting effects on trust in civil servants.
This suggests that both factors are important, but the quality of governance has a more enduring impact.
...
We expect this dataset will enrich cross-national research and facilitate more robust investigations into the causes and consequences of trust in civil servants across different contexts.
...
Given these mixed results from studies on outcomes and quality in relation to trust, researchers acknowledge common limitations: limited country coverage, reliance on cross-sectional rather than dynamic analysis, and difficulties in obtaining comparable measures across countries or regions [@VanRyzin2011; @Houston2016;@Choi2018; @Morelock2021;@VandeWalle2022].
These limitations in comparative data and the lack of time-series data hinder a deeper understanding of the relationship between government outcomes, quality, and trust in bureaucracies.

To overcome these data limitations, we measured trust in civil servants cross-nationally and examined the competing theories on the sources of trust in civil servants .
