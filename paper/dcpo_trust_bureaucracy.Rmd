...
countries <- c("Germany","United States","Switzerland","Finland",
...
The TCS scores closely align with trends in trust in the executive branch over time, effectively capturing historical changes in trust. 
...
However, the variation in correlations between TCS scores and trust in different institutions requires empirical analysis of political trust's dimensions.
...
Finally, we addressed measurement uncertainty in the data for trust in bureaucracies, income inequality, and the Corruption Perceptions Index by incorporating it directly into the analysis (see @Tai2024). 
